 ...
 <head>
  ...
  <!--=== nivo slider ===-->
  <link rel="stylesheet" href="assets/css/plugin/nivo-slider.css">
  <link rel="stylesheet" href="assets/css/plugin/preview.css" media="screen">
  <!-- ====carousel======= -->
...
<body>
             ...
             <div class="header-top-area clear-fix pt-20 pb-20">
               <div class="container">
                 <div class="row">
                  ...
                  <div class="col-md-6">
                   <div class="top-midle">
                     <li><span>Call Now</span><a href="#">01772488816</a></li>
                     <li><span>E-mail</span><a href="#">foysal@gmail.com</a></li>
                   </div>
                 </div>
                 <div class="col-md-3">
                   <div class="btn-area">
                     <a href="#" id="btn">Appoinment</a>
                   </div>
                 </div>
               </div>
             </div>
                 ...
                 <div class="header-right">
                   <nav>
                    <ul>
                      ...
                      <li><a href="#">Ambulence</a>
                       <ul class="submenu">
                        <li  class="smooth-menu"><a href="#">Blood</a></li>
                        <li  class="smooth-menu"><a href="#">Doctor Appoinment</a></li>
                        <li><a href="#">Report</a></li>
                        <li><a href="#">Seat Booking</a></li>
                      </ul>
                    </li>
                    <li><a href="#">Blood</a>
                      <ul class="submenu">
                        <li  class="smooth-menu"><a href="bsearch.html">Find Donor</a></li>
                        <li  class="smooth-menu"><a href="donor.html">Be a Donor</a></li>
                        <li><a href="#">Update d-time</a></li>
                        <li><a href="donorlist.html">Donor list</a></li>
                        
                      </ul>
                    </li>
                    <li><a href="savailable.html">Patient Seat available</a></li>
                    <li><a href="#">Seat Booking</a></li>
                ...
                <div class="search-box">
                 <form action="">
                  ...
                  <div class="search-btn">
                   ...
                   <input type="submit" value="Search" id="srch-btn" >
                 </form>
              </div>
             </div> 
           </div>
 ...
 <div class="b_search text-center">
   <p>Username এবং Password দিয়ে রক্তদাতা হিসাবে রেজিস্ট্রেশন করুন, এতে পরবর্তীতে আপনি আপনার একাউন্টে লগইন করে আপনার তথ্য যেমন রক্তদানের শেষ তারিখ, মোবাইল নম্বর, জেলা/এলাকা পরিবর্তন করতে পারবেন। দয়া করে রক্তদান শেষে রক্তদানের শেষ তারিখ আপডেট করুন। এই ওয়েবসাইটে রক্তদাতাদের নাম এবং পুরুষ/মহিলা এই তথ্য প্রকাশ করা হবে না। মোবাইল নম্বর প্রকাশ করা হবে যেন রক্তের প্রয়োজনে রোগীরা সরাসরি রক্তদাতাদের সাথে যোগাযোগ করতে পারেন। <span>রক্ত দিন, জীবন বাচান :) <a href="donor.html">Be a donor.</a></span></p>
   <h2>Be a regular blood donor</h2>
   <form action="">
     <table>
       <tr><td>First Name:</td><td><input class="form-control" type="text"></td></tr>
       <tr><td>Last  Name:</td><td><input class="form-control" type="text"></td></tr>
       <tr><td>Gender:</td><td><label class="radio-inline"><input type="radio" name="optradio" checked>male</label><label class="radio-inline"><input type="radio" name="optradio">Female</label></td></tr>
       <tr><td>Date of Birth:</td><td><input class="form-control" type="date" name="bday"></td></tr>
        <tr><td>Blood Group:</td><td><select name="" id="b-group" class="form-control">
       ...
       <tr><td>District:</td><td><select name="" id="b-group" class="form-control">
         <option value="">A+</option>
         <option value="">A-</option>
         <option value="">B+</option>
         <option value="">B-</option>
       ...
       <tr><td>Area:</td><td><select name="" id="b-group" class="form-control">
         <option value="">A+</option>
         <option value="">A-</option>
         <option value="">B+</option>
         <option value="">B-</option>
       ...
       <tr><td>Last Donation Time:</td><td><input class="form-control" type="text"></td></tr>
       <tr><td>Contact Number:</td><td><input class="form-control" type="text"></td></tr>
       <tr><td>Facebook Id:</td><td><input class="form-control" type="text"></td></tr>
       <tr><td>Email:</td><td><input class="form-control" type="email"></td></tr>
       <tr><td>Username:</td><td><input class="form-control" type="text"></td></tr>
       <tr><td>Password:</td><td><input class="form-control" type="password"></td></tr>
